...
Note: SITARANG menggunakan waktu Jakarta / Waktu Indonesia Barat. Jika ingin mengganti waktu yang digunakan, ganti nilai `APP_TIMEZONE` di .env
...
- Buat Cron Job (Linux) atau Task Scheduler (Windows) untuk menjalankan perintah schedule Laravel karena SITARANG menggunakan [Laravel Scheduler](https://laravel.com/docs/8.x/scheduling).
...
- Ganti `/path/ke/projekmu` dengan path projek SITARANG kamu
...
### Lisensi
SITARANG menggunakan [lisensi MIT](https://github.com/fajarwz/SITARANG/blob/main/LICENSE)
