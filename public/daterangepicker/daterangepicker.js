  ...
  \********************************************/
	...
	---------------------------------------------------------------------- */
                                    ...
                                    if (
                                        ...
                                        assert(function (el) {
                                            ...
                                            el.appendChild(input).setAttribute(
                                                "name",
                                                "D"
                                            );
	...
	---------------------------------------------------------------------- */
                                ...
                                Sizzle.matchesSelector = function (elem, expr) {
                                    ...
                                    return (
                                        Sizzle(expr, document, null, [elem])
                                            .length > 0
                                    );
                                };
                                ...
                                Sizzle.uniqueSort = function (results) {
                                    ...
                                    sortInput =
                                        !support.sortStable && results.slice(0);
                                ...
                                getText = Sizzle.getText = function (elem) {
                                    ...
                                    if (!nodeType) {
                                        ...
                                        if (
                                            typeof elem.textContent === "string"
                                        ) {
			...
			*/
                        ...
                        function adoptValue(value, resolve, reject, noValue) {
                            ...
                            try {
                                ...
                                if (
                                    value &&
                                    isFunction((method = value.promise))
                                ) {
                                    method
                                        .call(value)
                                        .done(resolve)
                        ...
                        (function () {
                            ...
                            function computeStyleTests() {
                                ...
                                scrollboxSizeVal =
                                    roundPixelMeasures(div.offsetWidth / 3) ===
                                    12;
                        ...
                        function defaultPrefilter(elem, props, opts) {
                            var prop,
                                ...
                                style = elem.style,
                                hidden =
                                    elem.nodeType && isHiddenWithinTree(elem),
                        ...
                        jQuery.each(
                            ...
                            function (_i, name) {
                                var getter =
                                    attrHandle[name] || jQuery.find.attr;
		...
		*/
                            ...
                            ajax: function (url, options) {
                                ...
                                function done(
                                    ...
                                    if (
                                        !isSuccess &&
                                        jQuery.inArray("script", s.dataTypes) >
                                            -1
                                    ) {
                ...
                (function (root, factory) {
                    ...
                    var DateRangePicker = function DateRangePicker(
                        ...
                        if (_typeof(options) !== "object" || options === null)
                            options = {}; //allow setting options with data attributes
                        ...
                        if (_typeof(options.locale) === "object") {
                            ...
                            if (_typeof(options.locale.daysOfWeek) === "object")
                                this.locale.daysOfWeek =
                                    options.locale.daysOfWeek.slice();
                            if (_typeof(options.locale.monthNames) === "object")
                                this.locale.monthNames =
                                    options.locale.monthNames.slice();
                            if (typeof options.locale.firstDay === "number")
                                this.locale.firstDay = options.locale.firstDay;
                            if (typeof options.locale.applyLabel === "string")
                                this.locale.applyLabel =
                                    options.locale.applyLabel;
                            if (typeof options.locale.cancelLabel === "string")
                                this.locale.cancelLabel =
                                    options.locale.cancelLabel;
                            if (typeof options.locale.weekLabel === "string")
                                this.locale.weekLabel =
                                    options.locale.weekLabel;

                            if (
                                typeof options.locale.customRangeLabel ===
                                "string"
                            ) {
                        ...
                        if (_typeof(options.startDate) === "object")
                            this.startDate = moment(options.startDate);
                        if (_typeof(options.endDate) === "object")
                            this.endDate = moment(options.endDate);
                        if (_typeof(options.minDate) === "object")
                            this.minDate = moment(options.minDate);
                        if (_typeof(options.maxDate) === "object")
                            this.maxDate = moment(options.maxDate); // sanity check for bad options

                        if (
                            this.minDate &&
                            this.startDate.isBefore(this.minDate)
                        )
                            this.startDate = this.minDate.clone(); // sanity check for bad options
                        ...
                        if (typeof options.cancelButtonClasses === "string")
                            this.cancelButtonClasses =
                                options.cancelButtonClasses;
                        if (typeof options.cancelClass === "string")
                            //backwards compat
                            this.cancelButtonClasses = options.cancelClass;
                        if (_typeof(options.maxSpan) === "object")
                        ...
                        if (typeof options.alwaysShowCalendars === "boolean")
                            this.alwaysShowCalendars =
                                options.alwaysShowCalendars; // update day names order to firstDay
                        ...
                        if (_typeof(options.ranges) === "object") {
                            for (range in options.ranges) {
                                if (
                                    typeof options.ranges[range][0] === "string"
                                )
                                    start = moment(
                                ...
                                if (
                                    typeof options.ranges[range][1] === "string"
                                )
                                    end = moment(
                                        options.ranges[range][1],
                                        this.locale.format
                                    );
                                else end = moment(options.ranges[range][1]); // If the start or end date exceed those allowed by the minDate or maxSpan
                                ...
                                if (maxDate && end.isAfter(maxDate))
                                    end = maxDate.clone(); // If the end of the range is before the minimum or the start of the range is
                                ...
                                if (
                                    ...
                                    continue; //Support unicode chars in the range names.
                        ...
                        if (
                            ...
                            this.element.on({
                                "click.daterangepicker": $.proxy(
                                    this.show,
                                    this
                                ),
                                "focus.daterangepicker": $.proxy(
                                    this.show,
                                    this
                                ),
                    ...
                    DateRangePicker.prototype = {
                        ...
                        renderCalendar: function renderCalendar(side) {
                            ...
                            var minDate =
                                side == "left" ? this.minDate : this.startDate;
                            var maxDate = this.maxDate;
                            var selected =
                            ...
                            if (
                                (!minDate ||
                                    minDate.isBefore(calendar.firstDay)) &&
                            ...
                            if (this.showDropdowns) {
                                ...
                                var maxYear =
                                    (maxDate && maxDate.year()) || this.maxYear;
                                var minYear =
                                    (minDate && minDate.year()) || this.minYear;
                            ...
                            if (
                                (!maxDate ||
                                    maxDate.isAfter(calendar.lastDay)) &&
                                (!this.linkedCalendars ||
                                    side == "right" ||
                                    this.singleDatePicker)
                            ) {
                            ...
                            for (var row = 0; row < 6; row++) {
                                ...
                                for (var col = 0; col < 7; col++) {
                                    ...
                                    if (
                                        calendar[row][col].isSame(
                                            new Date(),
                                            "day"
                                        )
                                    )
                                        classes.push("today"); //highlight weekends

                                    if (calendar[row][col].isoWeekday() > 5)
                                        classes.push("weekend"); //grey out the dates in other months displayed at beginning and end of this calendar

                                    if (
                                        calendar[row][col].month() !=
                                        calendar[1][1].month()
                                    )
                                        classes.push("off", "ends"); //don't allow selection of dates before the minimum date
                                    ...
                                    if (
                                        ...
                                        classes.push("off", "disabled"); //don't allow selection of dates after the maximum date
                                    ...
                                    if (
                                        ...
                                        classes.push("off", "disabled"); //don't allow selection of date if a custom function decides it's invalid

                                    if (this.isInvalidDate(calendar[row][col]))
                                        classes.push("off", "disabled"); //highlight the currently selected start date
                                    ...
                                    if (
                                        ...
                                        classes.push("active", "start-date"); //highlight the currently selected end date
                                    ...
                                    if (
                                        ...
                                        classes.push("active", "end-date"); //highlight dates in-between the selected dates
                                    ...
                                    if (
                                        ...
                                        classes.push("in-range"); //apply custom classes for this date
                        ...
                        hoverDate: function hoverDate(e) {
                            ...
                            var date = cal.hasClass("left")
                                ...
                                : this.rightCalendar.calendar[row][col]; //highlight the dates between the start date and the date being hovered as a potential end date
                            ...
                            for (var range in this.ranges) {
                                if (this.timePicker) {
                                    var format = this.timePickerSeconds
                                        ? "YYYY-MM-DD HH:mm:ss"
                                        : "YYYY-MM-DD HH:mm"; //ignore times when comparing dates if time picker seconds is not enabled

                                    if (
                                        this.startDate.format(format) ==
                                            this.ranges[range][0].format(
                                                format
                                            ) &&
                        ...
                        monthOrYearChanged: function monthOrYearChanged(e) {
                            var isLeft = $(e.target)
                                ...
                                cal = this.container.find(
                                    ".drp-calendar." + leftOrRight
                                ); // Month must be Number for new moment versions

                            var month = parseInt(
                                cal.find(".monthselect").val(),
                                10
                            );
                        ...
                        timeChanged: function timeChanged(e) {
                            ...
                            var hour = parseInt(
                                cal.find(".hourselect").val(),
                                10
                            );
                            var minute = parseInt(
                                cal.find(".minuteselect").val(),
                                10
                            );
                        ...
                        updateElement: function updateElement() {
                            if (
                                ...
                                var newValue = this.startDate.format(
                                    this.locale.format
                                );
  ...
  \************************************************************/
            ...
            /***/ function (module, exports, __webpack_require__) {
                module.exports = __webpack_require__(
                    /*! /var/www/html/SITARANG/resources/daterangepicker/daterangepicker.js */ "./resources/daterangepicker/daterangepicker.js"
                );
