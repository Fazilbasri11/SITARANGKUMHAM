                ...
                (function ($, window, document) {
                    ...
                    var Timepicker = function Timepicker(element, options) {
                        ...
                        this.showWidgetOnAddonClick =
                            options.showWidgetOnAddonClick;
                        ...
                        this.handleDocumentClick = function (e) {
                            ...
                            if (
                                !(
                                    self.$element.parent().find(e.target)
                                        .length ||
                    ...
                    Timepicker.prototype = {
                        ...
                        _init: function _init() {
                            ...
                            if (
                                ...
                                this.$element
                                    .parent()
                                    .hasClass("bootstrap-timepicker")
                            ) {
                                this.$element
                                    .parent(".input-group.bootstrap-timepicker")
                                    .find(".input-group-addon")
                                    .on({
                                        "click.timepicker": $.proxy(
                                            this.showWidget,
                                            this
                                        ),
                                    });
                                this.$element.on({
                                    "focus.timepicker": $.proxy(
                                        this.highlightUnit,
                                        this
                                    ),
                                    "click.timepicker": $.proxy(
                         ...
                         * round up to 60.
                         */
                        changeToNearestStep: function changeToNearestStep(
                            segment,
                            step
                        ) {
                            if (segment % step === 0) {
                        ...
                        place: function place() {
                            ...
                            if (yorient === "auto") {
                                topOverflow =
                                    -scrollTop + offset.top - widgetHeight;
                                bottomOverflow =
                                    scrollTop +
                                    windowHeight -
                        ...
                        updateFromWidgetInputs:
                            function updateFromWidgetInputs() {
                                if (this.$widget === false) {
                                    return;
                                }
  ...
  \*************************************************************************/
            ...
            /***/ function (module, exports, __webpack_require__) {
                module.exports = __webpack_require__(
                    /*! /var/www/html/SITARANG/resources/bootstrap-timepicker/js/bootstrap-timepicker.js */ "./resources/bootstrap-timepicker/js/bootstrap-timepicker.js"
                );
